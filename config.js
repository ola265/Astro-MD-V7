...
ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://i.imgur.com/aSm8fGZ.jpeg' : process.env.ALIVE_LOGO,
FOOTER: process.env.FOOTER === undefined ? 'VIRUS-BOT PUBLIC STABLE' : process.env.FOOTER,
